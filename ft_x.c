...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/23 14:41:50 by masboula          #+#    #+#             */
/*   Updated: 2020/12/23 15:23:34 by masboula         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	ft_x_flag(t_format *comb, char *str, int *count, unsigned int num)
{
	int	i;
	int	l;
	int	tmp;
...
int		ft_x_flag2(t_format *comb, char *str, int *count, unsigned int num)
{
	int	l;
	int tmp;
...
void	ft_x_prec(t_format *comb, char *str, int *count, unsigned int num)
{
	int	l;
	int i;
